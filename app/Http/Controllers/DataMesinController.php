...
class DataMesinController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('data-mesin.index')->with('success', 'Data mesin  ' . implode(', ', $selectednama_mesin) . ' milik ' . $pemilik . ' berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        return redirect()->route('data-mesin.index')->with('success', 'Data mesin  ' . implode(', ', $selectednama_mesin) . ' milik ' . $pemilik . ' berhasil diubah!');
    }
