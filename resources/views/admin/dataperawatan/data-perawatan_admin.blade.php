                        ...
                        <div class="col-12 ml-1 mr-1">
                            ...
                            <div class="row g-1">
                                <div class="col-auto mb-3">
                                    <a href="{{ route('data-perawatan_admin.create') }}" class="btn btn-md mb-0 mt-1"
                                            ...
                                            <tbody class="text">
                                                @forelse ($data_perawatans as $data_perawatan)
                                                    <tr>
                                                        ...
                                                        <td>{{ $data_perawatan->user->name }}</td>
                                                        <td>
                                                            <form
                                                                onsubmit="event.preventDefault(); confirmDelete(this);"
                                                                action="{{ route('data-perawatan.destroy', $data_perawatan->id) }}"
                                                                method="POST">
                                                                <a href="{{ route('data-perawatan_admin.edit', $data_perawatan->id) }}"
