...
<head>
    ...
    <title>Pemilik Mesin | Pantau Mesin</title>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="mt-2" style="margin-left: 40px">
                        <a href="{{ route('pemilik-mesin.create') }}" class="btn btn-md mb-3"
                    ...
                    <div class="row ml-4 mr-4">
                        <div class="col-12 ml-1 mr-1">
                            ...
                            <div class="card border-0 mt-2"
                                            ...
                                            <tbody class="text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form
                                                                ...
                                                                action="{{ route('pemilik-mesin.destroy', $item->id) }}"
                                                                method="POST">
                                                                <a href="{{ route('pemilik-mesin.edit', $item->id) }}"
                                                ...
                                                @empty
                                                    <div class="alert alert-danger">
                                                        Data Pemilik Mesin belum Tersedia.
                                                    </div>
                                                @endforelse
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-md-12">
                                    @foreach ($pemilik_mesins as $item)
                                    @endforeach
                                    {{ $pemilik_mesins->links('pagination::bootstrap-5') }}
                                </div>
