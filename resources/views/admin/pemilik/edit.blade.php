...
<head>
    ...
    <title>Edit Data Pemilik Mesin | Pantau Mesin</title>
                        ...
                        <div class="row ml-3 mr-3">
                            <div class="col-md-12">
                                ...
                                <div class="card border-0"
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('pemilik-mesin.update', $pemilik_mesins->id) }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group mt-3">
                                                        ...
                                                        <select class="form-control" id="user_id" name="user_id"
                                                            required>
                                                            <option value="" disabled>Pilih Nama Pemilik
                                                            </option>
                                                    ...
                                                    <div class="col-md-6 form-group mt-3">
                                                        ...
                                                        <select class="form-control" id="mesin_id" name="mesin_id"
                                                            required>
                                                            <option value="" disabled>Pilih Mesin
                                                            </option>
