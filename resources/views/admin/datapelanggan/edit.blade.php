                        ...
                        <div class="row ml-3 mr-3">
                            <div class="col-md-12">
                                ...
                                <div class="card border-0"
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('pelanggan.update', $data_pelanggans->id) }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group mt-3">
                                                        ...
                                                        <input type="text" class="form-control" name="nama"
                                                            value="{{ old('nama', $data_pelanggans->nama) }}"
                                                            placeholder="Masukkan nama pelanggan" required>
                                                    </div>
                                                    <div class="col-md-6 form-group mt-3">
                                                        <label class="font-weight-bold">No Hp</label>
                                                        <input type="text" class="form-control" name="no_hp"
                                                            value="{{ old('no_hp', $data_pelanggans->no_hp) }}"
                                                            placeholder="Masukkan no hp" required>
                                                    </div>
                                                    <div class="col-md-6 form-group mt-3">
                                                        <label class="font-weight-bold">Alamat</label>
                                                        <input type="text" class="form-control" name="alamat"
                                                            value="{{ old('alamat', $data_pelanggans->alamat) }}"
                                                            placeholder="Masukkan alamat" required>
                                                    </div>
                                                    <div class="col-md-6 form-group mt-3">
                                                        <label class="font-weight-bold">Email</label>
                                                        <input type="text" class="form-control" name="email"
                                                            value="{{ old('email', $data_pelanggans->email) }}"
