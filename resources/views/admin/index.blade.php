...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/img/Logo.png" alt="" >
  </div>

  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand" style="background-color:#1E56A0; color:white;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar elevation-4" style="background-color: #1E56A0;">
    <!-- Brand Logo -->
    <a href="" class="brand-link" style="text-align: center;">
      <img src="/img/Logo2.png" alt="" style="opacity: .8">
